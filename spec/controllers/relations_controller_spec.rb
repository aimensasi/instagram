...
RSpec.describe RelationsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all relations as @relations" do
      ...
      expect(assigns(:relations)).to eq([relation])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested relation as @relation" do
      relation = Relation.create! valid_attributes
      get :show, params: {id: relation.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested relation as @relation" do
      relation = Relation.create! valid_attributes
      get :edit, params: {id: relation.to_param}, session: valid_session
      expect(assigns(:relation)).to eq(relation)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Relation" do
        expect {
          post :create, params: {relation: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved relation as @relation" do
        post :create, params: {relation: invalid_attributes}, session: valid_session
        expect(assigns(:relation)).to be_a_new(Relation)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested relation" do
        relation = Relation.create! valid_attributes
        put :update, params: {id: relation.to_param, relation: new_attributes}, session: valid_session
        relation.reload
      ...
      it "assigns the requested relation as @relation" do
        relation = Relation.create! valid_attributes
        put :update, params: {id: relation.to_param, relation: valid_attributes}, session: valid_session
        expect(assigns(:relation)).to eq(relation)
      end
      ...
      it "redirects to the relation" do
        relation = Relation.create! valid_attributes
        put :update, params: {id: relation.to_param, relation: valid_attributes}, session: valid_session
        expect(response).to redirect_to(relation)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the relation as @relation" do
        relation = Relation.create! valid_attributes
        put :update, params: {id: relation.to_param, relation: invalid_attributes}, session: valid_session
        expect(assigns(:relation)).to eq(relation)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested relation" do
      relation = Relation.create! valid_attributes
      expect {
        delete :destroy, params: {id: relation.to_param}, session: valid_session
      }.to change(Relation, :count).by(-1)
    end
